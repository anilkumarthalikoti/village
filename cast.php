...
$conn=$database;
if(!empty($_POST)){
$conn->insert("casts",array("castname"=>strtoupper($_POST["castname"]),"castname_k"=>$_POST["castname_k"]));
...
<tbody>
<?php 
$result=$conn->select("casts",array("castname","castname_k"));
foreach($result as $row){
echo "<tr><td>".$row["castname"]."</td><td>".$row["castname_k"]."</td></tr>";
}
