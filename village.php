            ...
            <div class="container" id="tab8C">
                <form name="zpconstituency">
                    ...
                    <table class="form margin-left margin-top">
                        ...
                        <tr><td class="label">Enter Zp-Constituency</td><td>:</td><td><input type="text" name="state_name" placeholder="Enter zp constituency" /><input type="text" name="state_name_ka" placeholder="Enter zp constituency" alt="ka" id="s9" /></td></tr>
            ...
            <div class="container" id="tab9C">
                <form name="tpconstituency">
                    ...
                    <table class="form margin-left margin-top">
                        ...
                        <tr><td class="label">Enter Tp-Constituency</td><td>:</td><td><input type="text" name="state_name" placeholder="Enter tp constituency" /><input type="text" name="state_name_ka" placeholder="Enter tp constituency" alt="ka" id="s8" /></td></tr>
                        <tr><td colspan="3"> <input type="button" value="Save" onClick="states.saveData('tpconstituency')" /></td></tr>
                        <tr><td colspan="3">
                    ...
                    <table class="grid margin xlarge" grid="tpconstituency">
                        <thead>
