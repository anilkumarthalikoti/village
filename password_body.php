<table width="85%" border="0" cellspacing="0" cellpadding="0" style=" border:1px solid #CCC" align="center" bgcolor="#FFFFFF">
  <tr>
    <td bgcolor="#339933" style="color:#FFF; padding:10px; font-weight:bold; font-family:Arial, Helvetica, sans-serif" align="center">
 Reset Password</td>
  </tr>
  <tr><td>&nbsp;</td></tr>
  <tr>
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td valign="top" align="center" width="20%" style="padding:10px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td>CURRENT PASSWORD <span style="color:#F00">*</span><br><input name="text" type="text" id="username" placeholder="Enter Current Password" style="height:15px; width:200px; color:#333; border:1px solid #000; font-family:Arial, Helvetica, sans-serif; font-size:13px;"/></td>
            </tr>
          <tr>
            <td style="height:10px;"></td>
            </tr>
          <tr>
            <td>NEW PASSWORD <span style="color:#F00">*</span><br><input name="text" type="text" id="username" placeholder="Enter New Password" style="height:15px; width:200px; color:#333; border:1px solid #000; font-family:Arial, Helvetica, sans-serif; font-size:13px;"/></td>
            </tr>
          <tr>
            <td style="height:10px;"></td>
            </tr>
          <tr>
            <td>CONFIRM NEW PASSWORD <span style="color:#F00">*</span><br><input name="text" type="text" id="username" placeholder="Enter Confirm new Password" style="height:15px; width:200px; color:#333; border:1px solid #000; font-family:Arial, Helvetica, sans-serif; font-size:13px;"/></td>
            </tr>
          </table></td>
        <td valign="top" align="center" width="50%" style="padding:10px;"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-left:1px solid #CCC; padding-left:10px;">
          ...
          <tr>
            <td style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#333; line-height:30px; padding:10px;">	
              Does not contain illegal characters	<br>
