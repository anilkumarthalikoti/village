...
(filling_id INT NOT NULL,
 ...
 area1 float,area2 float,area3 float,spacing1 float,spacing2 float, spacing3 float,dealerid int,orgid int,vatat float,pspacing1 float,pspacing2 float, pspacing3 float,aspacing1 float,aspacing2 float, aspacing3 float,
PRIMARY KEY (filling_id));
